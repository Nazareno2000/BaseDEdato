...
INSERT INTO Ciudad3(Cod_postal,Nombre,id_provincia)
...
('Romerir','Chiquito',43355678,'Romero10@hotmail.com','19410 de julio',3459,False,3274),
('Romerira','Chiquito',43355679,'Romero110@hotmail.com','194101 de julio',3489,False,3274),
('Romerirar','Chiquito',43355689,'Romero1110@hotmail.com','194101 de julio',3499,False,3274);

INSERT INTO Factura2(id_factura,fecha,monto,DNI)
VALUES(1,14072000,500,42477160),(2,15072000,600,42477161),(3,16072000,700,42477162),(4,20072000,900,42477163),
(5,21072000,1500,42477164),(6,10072000,2500,42477165),(7,18072000,3500,42477166),(8,19072000,4500,42477167),
(9,30072000,5500,42477168),(10,29072000,6500,42477169),(11,06072000,5500,42477170),(12,05072000,32500,42477171),
(13,01072000,12500,42477172),(14,02072000,19500,42477173),(15,03072000,4500,42477174);

INSERT INTO Genero(id_genero,Nombre)
VALUES(1,'Romantico'),(2,'Fantasia'),(3,'Novela'),(4,'Terror'),(5,'Misterio');

INSERT INTO Oferta2(id_oferta,descuento)
...
INSERT INTO Libro3 (Isbn, Nombre,Precio_venta,Stock,Stock_min,id_genero,id_oferta,DNI_Autor,id_editoriaL)
...
VALUES (12,10,1),(13,10,2),(14,10,3),(15,10,4),(16,10,5),(17,10,6),(18,10,7),(19,10,8),(20,10,9),(21,10,10),
(22,10,11),(23,10,12),(24,10,13),(25,10,14),(26,10,15);



INSERT INTO Envio1(id_envio,Direccion,Nro_pedido,Cod_postal,id_carrito)
